        ...
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                   <FormLabel className="text-base font-semibold text-[#2A2A2A] leading-[120%]">Email <sup className="text-[#AAB7A2] text-lg font-bold">*</sup></FormLabel>
                  <FormControl>
                    <Input
            ...
            <div>
              <p className="text-sm text-[#363636] font-medium text-center pt-2 leading-[120%] ">Back to <Link className="text-primary font-bold underline" href="/login">Log In</Link></p>
              </div>
          </form>
        </Form>
      </div>
