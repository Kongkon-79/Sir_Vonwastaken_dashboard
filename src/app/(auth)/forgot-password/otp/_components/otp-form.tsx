  ...
  return (
    <div className="w-full px-4 md:px-0  flex items-center justify-center">
      <div className="w-full md:w-[570px] bg-white rounded-[16px] border-[2px] border-[#E7E7E7] shadow-[0px_0px_32px_0px_#0000001F] p-5 md:p-6">
        ...
        {/* OTP Input Fields */}
        <div className="flex gap-2 md:gap-5 lg:gap-6 w-full justify-center">
          {otp.map((digit, index) => (
            <Input
              key={index}
              type="text"
              ...
              className={` w-[44px] md:w-[60px] lg:w-[54px] h-[52px] md:h-[60px] lg:h-[64px] border border-[#606060] bg-[#EAEAEA] text-[#212121] placeholder:text-[#999999] text-center tracking-[0%] !text-xl font-semibold leading-[120%] focus:outline-none rounded-[8px] ${digit ? "border-[#212121]" : "border-black"
                }`}
        ...
        <div className="text-center flex items-center justify-between pt-5 lg:pt-6 pb-5 lg:pb-6">
          ...
          <button
            ...
            className=" text-base font-medium leading-[120%] text-[#5E6755] tracking-[0%] hover:underline"
          >
