      ...
      <Form {...form}>
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-base font-semibold text-[#2A2A2A] leading-[120%]">Password <sup className="text-[#AAB7A2] text-lg font-bold">*</sup></FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-base font-semibold text-[#2A2A2A] leading-[120%]">Confirm Password <sup className="text-[#AAB7A2] text-lg font-bold">*</sup></FormLabel>
                <FormControl>
                  <div className="relative">
                    <Input
